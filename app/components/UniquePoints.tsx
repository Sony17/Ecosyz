...
export default function UniquePoints() {
  return (
  <section className="py-16 sm:py-20 bg-gradient-to-br from-[#0c2321] via-[#121f22] to-[#0a1016] text-white relative">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          {/* Card 1 */}
          <div className="text-center glass-card glass-border rounded-xl p-6 transition hover:-translate-y-1">
